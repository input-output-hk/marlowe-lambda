***This package has been deprecated and is no longer maintained. Please use [the Marlowe web server](https://github.com/input-output-hk/marlowe-cardano/tree/main/marlowe-runtime/web-server-app) instead.***
